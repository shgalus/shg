...
/**
 * NIST Statistical Reference Datasets Linear Regression. This class
 * contains data for testing linear regression from <a href =
 * "http://www.itl.nist.gov/div898/strd/">NIST Statistical Reference
 * Datasets</a>. The data files were retrieved on 24 December 2010.
 * The class contains 11 datasets, described at <a href =
 * "http://www.itl.nist.gov/div898/strd/lls/lls.shtml">StRD Linear
 * Least Squares Regression Datasets</a>:
 *
...
private:
     ...
     const Data* d_ {&v_[0]};
     /**
      * Data. In src/strdlr.cc, this constant is automatically
      * generated by tools/gstrdlrd.cc.
      */
