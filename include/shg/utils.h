 ...
 * \exception std::out_of_range if the result is not representable in
 * type \c T
 * \exception std::runtime_error if an implementation error occurs
 *
 ...
 * -128\f$, \f$b = -1\f$, where 128 is not representable. In such
 * cases std::out_of_range is thrown.
 *
 * \implementation
 *
