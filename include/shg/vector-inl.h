/* vector-inl.h: implementation of vector class and functions */

/**
 * \file include/shg/vector-inl.h
 * Implementation of vector class and functions.
...
template <class T>
T& Vector<T>::operator[](std::size_t i) {return v_[i];}

template <class T>
const T& Vector<T>::operator[](std::size_t i) const {return v_[i];}
...
template <class T>
std::size_t Vector<T>::size() const {return n_;}
...
template <class T>
T* Vector<T>::c_vec() {return v_;}

template <class T>
const T* Vector<T>::c_vec() const {return v_;}
...
Vector<T> arithmetic_progression(std::size_t n, const T& a,
     ...
     Vector<T> v(n);
     std::size_t i = 0;
     std::generate_n(v.begin(), n, [a, d, &i] {return a + i++ * d;});
     return v;
}
