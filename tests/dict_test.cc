...
using SHG::PLP::Dictionary_error;
...
using SHG::PLP::Category;
using SHG::PLP::generate_all_categories;
...
BOOST_DATA_TEST_CASE(bad_data_test,
     ...
     auto is_correct = [&t](Dictionary_error const& e) {
