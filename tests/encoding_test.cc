...
BOOST_AUTO_TEST_CASE(string_conversions_test) {
     ...
     string const pla8 =
          "a\304\205bc\304\207de\304\231fghijkl\305\202mn\305\204o"
          "\303\263pqrs\305\233tuvwxyz\305\272\305\274\n"
          "A\304\204BC\304\206DE\304\230FGHIJKL\305\201MN\305\203O"
          "\303\223PQRS\305\232TUVWXYZ\305\271\305\273\n";
     // Polish alphabet in ISO 8859-2
     string const plaiso88592 =
     ...
     string const mba8 =
          "\360\235\220\200\360\235\220\201\360\235\220\202\360\235"
          "\220\203\360\235\220\204\360\235\220\205\360\235\220\206"
          "\360\235\220\207\360\235\220\210\360\235\220\211\360\235"
          "\220\212\360\235\220\213\360\235\220\214\360\235\220\215"
          "\360\235\220\216\360\235\220\217\360\235\220\220\360\235"
          "\220\221\360\235\220\222\360\235\220\223\360\235\220\224"
          "\360\235\220\225\360\235\220\226\360\235\220\227\360\235"
          "\220\230\360\235\220\231";
...
BOOST_AUTO_TEST_CASE(character_conversions_test) {
     ...
     std::set<unsigned char> const win_undef{0x81, 0x83, 0x88, 0x90,
                                             0x98};
     // Windows-1250 characters undefined in ISO 8859-2.
     std::set<unsigned char> const win_undef_in_iso{
     ...
     for (int i = 0; i < 256; i++) {
          char const c = i;
          char32_t const d = iso88592_to_utf32(c);
          ...
          if (win_undef.find(c) == win_undef.end()) {
               char32_t const d = windows1250_to_utf32(c);
...
BOOST_AUTO_TEST_CASE(kuhn_test) {
     for (auto const& [s, correct] : kuhn_data)
          if (correct)
               utf8_to_utf32(s);
          else
...
BOOST_AUTO_TEST_CASE(invalid_utf16_strings_test) {
     for (auto const& s : invalid_utf16)
