...
BOOST_AUTO_TEST_CASE(basic_test) {
     std::vector<double> const result1{
     ...
     std::vector<double> const result2{
     ...
     GSGTS::Cosine_transform const ct{nullptr};
     GSGTS::Real_transform const rt{nullptr};
     double const eps = 5e-8;
     std::vector<double> const acf1 = acfar1(1.0 / 64.0, 0.8, 129);
     std::vector<double> const acf2 = acfar1(0.5, 0.6, 80);
